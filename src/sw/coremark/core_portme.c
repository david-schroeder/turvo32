...
#define CM_STATIC_SYSCLK_PRESCALER 10
...
stop_time(void)
{
    ...
    ee_printf("CoreMark output:\033[1m\n\n");
}
/* Function : get_time
...
portable_fini(core_portable *p)
{
    ...
    // Output
    ee_printf("\033[0m\n");
    ee_printf("Average CPI during CoreMark execution: %d.%d [0x%08x_%08x/0x%08x_%08x]\n",
    ...
    ee_printf("Clock Speed: %d.%03dMHz\n", mhz_integer, mhz_fractional);
}
